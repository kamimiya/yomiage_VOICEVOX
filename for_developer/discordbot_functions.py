...
class room_information():
    def __init__(self, client = None, TEXT_ROOM_ID=0, TEXT_ROOM_NAME='', VOICE_ROOM_ID=0, VOICE_ROOM_NAME='', GUILD_ID=0):
        self.client = None
    ...
    async def execute_commands(self, message_tmp):
        ...
        if message_tmp.content == command_join:
            ...
            await self.client.change_presence(status=None, activity=game)
        ...
        # ボイスチャンネルから切断
            ...
            self.guild_id = 0
            # statusの初期化
            await self.client.change_presence(status=None, activity=None)
        # helpコマンド
